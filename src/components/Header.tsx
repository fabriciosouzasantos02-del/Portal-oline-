...
export const Header: React.FC = () => {
  ...
  return (
    <header id="wissensportal-header" className="relative mx-auto flex w-full max-w-[720px] flex-col items-center px-3 pb-5 pt-[clamp(15rem,30vh,20rem)] text-center sm:pb-8 sm:pt-[clamp(21rem,38vh,30rem)]">
