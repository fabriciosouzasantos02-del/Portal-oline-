...
export const Header: React.FC = () => {
  ...
  return (
    <header id="wissensportal-header" className="relative mx-auto flex w-full max-w-[720px] flex-col items-center px-3 pb-5 pt-[clamp(14rem,37vw,22rem)] text-center sm:pb-8">
