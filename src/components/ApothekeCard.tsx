...
export const ApothekeCard: React.FC = () => {
  return (
    <article id="card-verbotene-apotheke" className="group relative w-full overflow-hidden rounded-[18px] shadow-[0_14px_38px_-10px_rgba(0,0,0,.9)] transition-transform duration-300 hover:-translate-y-1">
      <a
        id="btn-archiv-oeffnen"
        href={CONTENT.card1.url}
        target="_blank"
        rel="noopener noreferrer"
        aria-label={CONTENT.card1.buttonText}
      ...
      >
        <img
          src={ASSETS.apothekeCard}
          alt="Die verbotene Apotheke – Archiv 1910"
